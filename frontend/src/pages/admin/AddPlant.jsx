  ...
  return (
    <div className="min-h-screen pt-20 pb-16 bg-gray-50/50 dark:bg-gray-900/50">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl font-bold">Add New Plant</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">Add a new plant to your nursery catalog</p>
        </div>
